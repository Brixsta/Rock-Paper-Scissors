...
if (window.innerWidth < 800 || window.innerHeight < 600) {
  alert("This game is intended for devices with at LEAST 800x600 resoultion.");
...
function removeAllBtnEventListeners() {
  ...
  scissorsAttackBtn.removeEventListener("click", handleScissorsAttackBtnClick);
}
...
function determineWinner() {
  ...
  if (pChoice === "rock" && cChoice === "scissors") global.winner = "You Win!";
  ...
  if (pChoice === "scissors" && cChoice === "scissors") global.winner = "Tie!";
  if (pChoice === "scissors" && cChoice === "rock")
    global.winner = "Computer Wins!";
  if (pChoice === "scissors" && cChoice === "paper") global.winner = "You Win!";
}
